...
import { Chip, Container, FormControlLabel, Grid, Paper, Stack, Typography } from '@mui/material';
...
const ListJobDetailComponent: FC<IListJobDetailComponentProps> = ({ open, onClose, jobPostId }) => {
  ...
  const { data, isLoading } = useQuery({ ...query, enabled: !!jobPostId });
          ...
          <Container maxWidth="md">
            ...
            >
              ...
              <Stack direction="row" alignItems="center" justifyContent="space-between">
                ...
                <FormControlLabel
                  control={
                    <StyledCheckbox name="checked" checked={!!jobData?.isBigEvent} disabled />
                  }
                  label={
