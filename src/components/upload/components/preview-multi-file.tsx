            ...
            <Box component="li" key={name} sx={{ display: 'inline-flex' }}>
              <FileThumbnail
                ...
                sx={{
                  ...
                  height: 80,
                  border: (theme) =>
                    `solid 1px ${alpha(theme.vars.palette.grey['500Channel'], 0.16)}`,
                }}
        ...
        return (
          <Box
            ...
            sx={{
              ...
              borderRadius: 1,
              alignItems: 'center',
              border: (theme) => `solid 1px ${alpha(theme.vars.palette.grey['500Channel'], 0.16)}`,
            }}
          >
            ...
            {onRemove && (
              <IconButton size="small" onClick={() => onRemove(file)}>
                <IconifyIcon icon="mingcute:close-line" width={16} />
              </IconButton>
            )}
          </Box>
        );
