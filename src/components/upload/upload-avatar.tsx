...
export function UploadAvatar({ sx, error, value, disabled, helperText, ...other }: UploadProps) {
  ...
  const renderPreview = hasFile && (
    ...
    <img src={preview} alt="avatar" style={{ width: 1, height: 1, borderRadius: '50%' }} />
  );
    ...
    <Box
      ...
      sx={{
        ...
        ...(hasFile && {
          ...
          opacity: 0,
          color: 'common.white',
          bgcolor: (theme) => alpha(theme.vars.palette.grey['900Channel'], 0.64),
        }),
      }}
    >
      <IconifyIcon icon="solar:camera-add-bold" width={32} />
